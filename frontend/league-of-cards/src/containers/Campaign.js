...
export default class Campaign extends React.Component {
  state = {
    ...
    storyText: [
      ...
      {sivir: "However, they saw potential in me as a mercenary, and decided to hire me as a bodyguard."},
      {sivir: "In his travels Ezreal found an ancient crystal fragment that compels him to reassemble it, promising enough power to conquer all of Runeterra."},
      ...
      {sivir: "Prince Jarvan has ordered an expedition to retrieve the fragment acquire the power needed to bring peace to Runeterra."},
      {sivir: "Thus, I travelled with to Demacia to prepare for our journey."},
      ...
      {ezreal: "We've found plenty of people who need more on our journey."},
      {ezreal: "We undertake this journey so Demacia can bring peace to the land."},
      ...
      {sivir: "A mercenary is always prepared to risk their lives."},
      {ezreal: "Sigh..."},
      ...
      {ascendedXerath: "But before he did that, I sealed a part of my consciousness in there, which allowed me to influence and drive any who touched it to attempt to assemble it and bring it here."},
