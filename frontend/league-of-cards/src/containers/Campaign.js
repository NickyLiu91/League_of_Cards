...
export default class Campaign extends React.Component {
  state = {
    ...
    storyText: [
      ...
      {sivir: "...!"},
      {azir: "Now, lets put an end to this treacherous snake!"},
      "AZIIIIIIIIR!!!!",
      ...
      {ezreal: "I am honored..."},
      {azir: "As a reward for the efforts, once I ressurect Shurima, I will ensure you are celebrated as heroes."},
